...
class OpportunitiesControllerTest < ActionController::TestCase
  ...
  test "should create opportunity" do
    assert_difference('Opportunity.count') do
      post :create, opportunity: { community_id: @opportunity.community_id, deadline: @opportunity.deadline, description: @opportunity.description, location: @opportunity.location, organization_id: @opportunity.organization_id, points: @opportunity.points, time: @opportunity.time, title: @opportunity.title, user_id: @opportunity.user_id, venue_id: @opportunity.venue_id }
    end
  ...
  test "should update opportunity" do
    patch :update, id: @opportunity, opportunity: { community_id: @opportunity.community_id, deadline: @opportunity.deadline, description: @opportunity.description, location: @opportunity.location, organization_id: @opportunity.organization_id, points: @opportunity.points, time: @opportunity.time, title: @opportunity.title, user_id: @opportunity.user_id, venue_id: @opportunity.venue_id }
    assert_redirected_to opportunity_path(assigns(:opportunity))
  end
